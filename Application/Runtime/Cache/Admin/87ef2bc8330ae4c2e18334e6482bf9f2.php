    ...
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                ...
                <li><a href="/blogs/index.php/Admin/Index/logout/">退出</a></li>
            </ul>
        </div>
    </div>
</div> 
    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/js/blogs/Public/Admin/css/admin/design/add" method="post" id="myform" name="myform" enctype="multipart/form-data">
