            ...
            <form action="" method="post">
                <ul class="admin_items">
                    <li>
                        ...
                        <input type="text" name="admin_name" value="admin" id="user" size="40" class="admin_input_style" />
                    </li>
                    <li>
                        <label for="pwd">密码：</label>
                        <input type="password" name="admin_pwd" value="123" id="pwd" size="40" class="admin_input_style" />
                    </li>
                    <li>
