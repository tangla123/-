    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/blogs/index.php/Admin/Vip/update/" method="post" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                    <tr>
                        <td><label for="user">用户名：</label></td>
                        <td> <input type="text" name="lo_name" id="user" size="40" class="admin_input_style" value="<?php echo ($data["lo_name"]); ?>" /></td>
                    </tr>
                    <tr>
                        <td><label for="pwd">密码：</label></td>
                        <td><input type="text" name="lo_pwd" id="pwd" size="40" class="admin_input_style" value="<?php echo ($data["lo_pwd"]); ?>"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>
                        <input type="hidden" value="<?php echo ($data["id"]); ?>" name="lo_id">
