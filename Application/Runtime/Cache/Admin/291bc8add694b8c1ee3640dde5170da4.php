    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/blogs/index.php/Admin/Friend/insert/" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody>
                            ...
                            <tr>
                                <th>网站链接：</th>
                                <td><input class="common-text" name="link_url" size="50" value="" type="text"></td>
                            </tr>
