...
<div class="topbar-wrap white">
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                ...
                <li><a href="/blogs/index.php/Admin/Blogcomment/logout/">退出</a></li>
            </ul>
        </div>
    </div>
</div> 
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/js/blogs/Public/Admin/css/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">评论管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/blogs/index.php/Admin/Blogcomment/sel/" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/blogs/index.php/Admin/Blogcomment/blogarticleinsert.html"><i class="icon-font"></i>新增作品</a>
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><!-- <td><?php echo ($v["art_id"]); ?></td> -->
                        <tr>
                            ...
                            <td>
                                ...
                                <input class="common-input sort-input" name="aord" value="" type="text">
                            </td>
                           
                            <td width="20px"><?php echo ($v["comment_id"]); ?></td>
                            <td width="300px"><?php echo ($v["title"]); ?></td>
                            <td width="300px"><?php echo ($v["comment_text"]); ?></td>
                            <td><?php echo ($v["comment_time"]); ?></td>
                            <td><?php echo ($v["add_time"]); ?></td>
                            <td><?php echo ($v["lo_name"]); ?></td>
                            
                            <td>
                                <a class="link-update" href="/blogs/index.php/Admin/Blogcomment/upblogarticle/id/<?php echo ($v["art_id"]); ?>">修改</a>
                                <a class="link-del" href="/blogs/index.php/Admin/Blogcomment/del/id/<?php echo ($v["art_id"]); ?>">删除</a>
                            </td>
