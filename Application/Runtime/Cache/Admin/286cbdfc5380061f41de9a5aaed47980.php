...
<div class="topbar-wrap white">
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/js/blogs/Public/Admin/css/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">分类管理</span></div>
        </div>
                   ...
                   <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr>
                        <!-- <td><?php echo ($v["cat_id"]); ?></td> -->
                            ...
                            <td>
                                ...
                                <input class="common-input sort-input" name="ord" value="<?php echo ($v["ord"]); ?>" type="text">
                            </td>
                            
                            <td><?php echo ($v["cat_id"]); ?></td>
                            <td><?php echo ($v["cat_name"]); ?></td>
                            <td><?php echo ($v["alias_name"]); ?></td>
                            <td><?php echo ($v["admin_name"]); ?></td>
                            <td><?php echo ($v["cat_timer"]); ?></td>
                            <td>
                                <a class="link-update" href="/blogs/index.php/Admin/Category/upcateinsert/id/<?php echo ($v["cat_id"]); ?>">修改</a>
                                <a class="link-del" href="/blogs/index.php/Admin/Category/del/id/<?php echo ($v["cat_id"]); ?>">删除</a>
                            </td>
