...
<div class="topbar-wrap white">
    <div class="topbar-inner clearfix">
        ...
        <div class="top-info-wrap">
            <ul class="top-info-list clearfix">
                ...
                <li><a href="/blogs/index.php/Admin/Blogreply/logout/">退出</a></li>
            </ul>
        </div>
    </div>
</div> 
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/js/blogs/Public/Admin/css/admin">首页</a><span class="crumb-step">&gt;</span><span class="crumb-name">回复管理</span></div>
        </div>
        <div class="search-wrap">
            <div class="search-content">
                <form action="/blogs/index.php/Admin/Blogreply/sel/" method="post">
            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="/blogs/index.php/Admin/Blogreply/blogarticleinsert.html"><i class="icon-font"></i>新增作品</a>
                ...
                <div class="result-content">
                    ...
                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><!-- <td><?php echo ($v["art_id"]); ?></td> -->
                        <tr>
                            <td><?php echo ($v["reply_id"]); ?></td>
                            <td><?php echo ($v["user_id"]); ?></td>
                            <td><?php echo ($v["reply_text"]); ?></td>
