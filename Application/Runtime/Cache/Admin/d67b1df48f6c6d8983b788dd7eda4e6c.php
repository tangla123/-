    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/blogs/index.php/Admin/Adminlog/insert/" method="post" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            <th width="120"><i class="require-red">*</i>管理员账号：</th>
                            <td>
                            ...
                            <tr>
                                <th><i class="require-red">*</i>管理员图像：</th>
                                <td><input name="admin_img" id="" type="file">
                              <!--   <input type="submit" onclick="submitForm('/js/blogs/Public/Admin/css/admin/design/upload')" value="上传图片"/> -->
                                </td>
                            </tr>
