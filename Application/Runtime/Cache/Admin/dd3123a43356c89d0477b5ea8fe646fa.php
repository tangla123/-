    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/blogs/index.php/Admin/Category/update/" method="post" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                ...
                                <td>
                                  <input type="text" name="alias_name" value="<?php echo ($data["alias_name"]); ?>">
                                </td>
                            </tr>
                             <tr>
                                <th><i class="require-red">*</i>排序：</th>
                                <td>
                                  <input type="text" name="ord" value="<?php echo ($data["ord"]); ?>">
                                </td>
                            </tr>
                            <tr>
                                <th>添加人：</th>
                                <td>
                                  <input type="text" name="addpeople_name" value="<?php echo ($data["addpeople_name"]); ?>">
                                </td>
                            </tr>
      <!--                       <tr>
