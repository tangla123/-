    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/blogs/index.php/Admin/Category/insert/" method="post" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        <tbody><tr>
                            ...
                            <tr>
                                <th>添加人：</th>
                                <td>
                                  <input type="text" name="addpeople_name" value="<?php echo (cookie('uid')); ?>">
                                </td>
                            </tr>
      <!--                       <tr>
